        ...
        <form onSubmit={handleSubmit}>
        {
          ...
          <label htmlFor='password'>
            <div style={{display:"flex", justifyContent:"space-between"}}>
              ...
              {
                !isSignup &&
                <p style={{color:"#007ac6",fontSize:'13px'}}>ForgetPassword</p>
               }
            </div>
          ...
          </label>
           {
            isSignup && (
              ...
              Opt-in to receive occassional<br/> product updates, user research invitations,<br/>company announcements, and digests.</p>
              </label>
            )
           }
